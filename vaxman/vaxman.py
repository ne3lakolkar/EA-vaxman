...
vaxman = pygame.image.load('C:/Users/neela/Downloads/vaxman-main/images/vaxman.png')
...
def startGame():
    ...
    Pacman = Player(w, p_h, "C:/Users/neela/Downloads/vaxman-main/images/vaxman.png")
    ...
    while done == False:
        ...
        for i in range(len(blinky_instances)):
            returned = blinky_instances[i].changespeed(Blinky_directions, False, b_turn, b_steps,
                                                       bl)
            b_turn = returned[0]
            b_steps = returned[1]
        ...
        if monsta_hit_list:
            for monsta in monsta_hit_list:
                monsta_list.remove(monsta)  # remove all instances from monsta_list that are in monsta_hit_list
                all_sprites_list.remove(monsta)  # remove all instances from all_sprites_list that are in monsta_hit_list
